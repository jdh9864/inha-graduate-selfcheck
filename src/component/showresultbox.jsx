...
export default function ShowResultBox({
  ...
  return (
    ...
    >
      ...
      {/* 본문: 결과 렌더 */}
      <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 text-gray-900">
        ...
        {!loading && !err && view && (
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <Stat title="학점요건 충족" value={view.credit.creditPassed ? "예" : "아니오"} ok={view.credit.creditPassed}/>
            </div>
            ...
            <div>
              ...
              {view.remainingCourses.length === 0 ? (
                <div className="text-sm text-gray-600">모두 이수했습니다.</div>
              ) : (
                <ul className="list-disc pl-5 text-sm leading-relaxed">
                  {view.remainingCourses.map((c, i) => (
                    <li key={`${c.courseNumber || i}-${i}`}>
